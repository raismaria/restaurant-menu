...
`;function q(e,t){return e.politeness===t.politeness?e.scheduled===t.scheduled?i.Equal:e.scheduled<t.scheduled?i.Less:i.Greater:"assertive"===e.politeness&&"assertive"!==t.politeness?i.Less:"assertive"!==e.politeness&&"assertive"===t.politeness?i.Greater:i.Equal}function B(){}function U(e,t={}){let n=z(t.from);if(!n){n=document.createElement("live-region"),t.appendTo?t.appendTo.appendChild(n):K(t.from).appendChild(n);let i=!1,r=()=>{i=!0};return{...J(X).then(()=>{if(!i){let i=n.announce(e,t);return r=i.cancel,i}}),cancel:()=>{r()}}}return n.announce(e,t)}function V(e,t={}){let n=z(t.from);if(!n){n=document.createElement("live-region"),t.appendTo?t.appendTo.appendChild(n):K(t.from).appendChild(n);let i=!1,r=()=>{i=!0};return{...J(X).then(()=>{if(!i){let i=n.announceFromElement(e,t);return r=i.cancel,i}}),cancel:()=>{r()}}}return n.announceFromElement(e,t)}function z(e){let t=null;return null!==(t=e?function(e){let t=e.closest("dialog"),n=e;for(;(n=n.parentElement)&&(!t||t.contains(n));)for(let e of n.childNodes)if(e instanceof LiveRegionElement)return e;return null}(e):null)||null!==(t=K(e).querySelector("live-region"))?t:null}function K(e){let t=document.body;if(e){let n=e.closest("dialog");n&&(t=n)}return t}customElements.get("live-region")||customElements.define("live-region",LiveRegionElement);let X=150;function J(e){return new Promise(t=>{setTimeout(t,e)})}},57226:(e,t,n)=>{n.d(t,{Ck:()=>ea,IN:()=>W,fK:()=>ee,lt:()=>V,zB:()=>D});var i,r,a,o,l,s,c=function(){return window.performance&&performance.getEntriesByType&&performance.getEntriesByType("navigation")[0]},u=(null===(i=c())||void 0===i?void 0:i.navigationId)||"1",d=function(e){if("loading"===document.readyState)return"loading";var t=c();if(t){if(e<t.domInteractive)return"loading";if(0===t.domContentLoadedEventStart||e<t.domContentLoadedEventStart)return"dom-interactive";if(0===t.domComplete||e<t.domComplete)return"dom-content-loaded"}return"complete"},h=function(e){var t=e.nodeName;return 1===e.nodeType?t.toLowerCase():t.toUpperCase().replace(/^#/,"")},f=function(e,t){var n="";try{for(;e&&9!==e.nodeType;){var i=e,r=i.id?"#"+i.id:h(i)+(i.classList&&i.classList.value&&i.classList.value.trim()&&i.classList.value.trim().length?"."+i.classList.value.trim().replace(/\s+/g,"."):"");if(n.length+r.length>(t||100)-1)return n||r;if(n=n?r+">"+n:r,i.id)break;e=i.parentNode}}catch(e){}return n},p=function(e,t,n,i){var r,a;return function(o){var l;t.value>=0&&(o||i)&&((a=t.value-(r||0))||void 0===r)&&(r=t.value,t.delta=a,t.rating=(l=t.value)>n[1]?"poor":l>n[0]?"needs-improvement":"good",e(t))}},m=-1,g=function(){return m},v=function(e){addEventListener("pageshow",function(t){t.persisted&&(m=t.timeStamp,e(t))},!0)},T=function(e){requestAnimationFrame(function(){return requestAnimationFrame(function(){return e()})})},b=function(){var e=c();return e&&e.activationStart||0},y=function(e,t,n,i){var r=c(),a="navigate";return n?a=n:g()>=0?a="back-forward-cache":r&&(document.prerendering||b()>0?a="prerender":document.wasDiscarded?a="restore":r.type&&(a=r.type.replace(/_/g,"-"))),{name:e,value:void 0===t?-1:t,rating:"good",delta:0,entries:[],id:"v3-".concat(Date.now(),"-").concat(Math.floor(0x82f79cd8fff*Math.random())+1e12),navigationType:a,navigationId:i||u}},E=function(e){return PerformanceObserver.supportedEntryTypes.includes("soft-navigation")&&e&&e.reportSoftNavs},w=function(e){if(e){var t=window.performance.getEntriesByType("soft-navigation").filter(function(t){return t.navigationId===e});return t?t[0]:void 0}},x=function(e,t,n){var i=E(n);try{if(PerformanceObserver.supportedEntryTypes.includes(e)){var r=new PerformanceObserver(function(e){Promise.resolve().then(function(){t(e.getEntries())})});return r.observe(Object.assign({type:e,buffered:!0,includeSoftNavigationObservations:i},n||{})),r}}catch(e){}},L=function(e){var t=function(t){"pagehide"!==t.type&&"hidden"!==document.visibilityState||e(t)};addEventListener("visibilitychange",t,!0),addEventListener("pagehide",t,!0)},S=-1,C=function(){return"hidden"!==document.visibilityState||document.prerendering?1/0:0},I=function(e){"hidden"===document.visibilityState&&S>-1&&(S="visibilitychange"===e.type?e.timeStamp:0,A())},k=function(){addEventListener("visibilitychange",I,!0),addEventListener("prerenderingchange",I,!0)},A=function(){removeEventListener("visibilitychange",I,!0),removeEventListener("prerenderingchange",I,!0)},N=function(){return arguments.length>0&&void 0!==arguments[0]&&arguments[0]&&(S=-1),S<0&&(S=C(),k(),v(function(){setTimeout(function(){S=C(),k()},0)})),{get firstHiddenTime(){return S}}},M=function(e){document.prerendering?addEventListener("prerenderingchange",function(){return e()},!0):e()},P=[1800,3e3],H=function(e,t){var n=E(t=t||{}),i=0;M(function(){var r,a=N(),o=y("FCP"),l=x("paint",function(s){s.forEach(function(s){if("first-contentful-paint"===s.name){n?s.navigationId&&s.navigationId!==o.navigationId&&function(n,l){if(r=p(e,o=y("FCP",0,n,l),P,t.reportAllChanges),"soft-navigation"===n){a=N(!0);var s=l?w(l):null;i=s&&s.startTime||0}}("soft-navigation",s.navigationId):l.disconnect();var c=0;if(s.navigationId&&s.navigationId!==u){var d=w(s.navigationId),h=d&&d.startTime?d.startTime:0;c=Math.max(s.startTime-h,0)}else c=Math.max(s.startTime-b(),0);var f=n&&s.navigationId?w(s.navigationId):null,m=f&&f.startTime?f.startTime:0;(s.startTime<a.firstHiddenTime||n&&s.navigationId&&s.navigationId!==o.navigationId&&s.navigationId!==u&&m>i)&&(o.value=c,o.entries.push(s),o.navigationId=s.navigationId||"1",r(!0))}})},t);l&&(r=p(e,o,P,t.reportAllChanges),v(function(n){r=p(e,o=y("FCP",0,"back-forward-cache",o.navigationId),P,t.reportAllChanges),T(function(){o.value=performance.now()-n.timeStamp,r(!0)})}))})},O=[.1,.25],W=function(e,t){var n,i,r,a,o,l,s;n=function(t){(function(e){if(e.entries.length){var t,n=e.entries.reduce(function(e,t){return e&&e.value>t.value?e:t});if(n&&n.sources&&n.sources.length){var i=(t=n.sources).find(function(e){return e.node&&1===e.node.nodeType})||t[0];if(i)return void(e.attribution={largestShiftTarget:f(i.node),largestShiftTime:n.startTime,largestShiftValue:n.value,largestShiftSource:i,largestShiftEntry:n,loadState:d(n.startTime)})}}e.attribution={}})(t),e(t)},o=E(i=(i=t)||{}),l=!1,s=0,H((r=function(){var e,t=y("CLS",0),r=0,a=[],c=function(a,o){if(e=p(n,t=y("CLS",0,a,o),O,i.reportAllChanges),r=0,l=!1,"soft-navigation"===a){var c=w(o);s=c&&c.startTime||0}},u=function(n){n.forEach(function(n){if(o&&n.navigationId&&n.navigationId!==t.navigationId&&(r>t.value&&(t.value=r,t.entries=a),e(!0),c("soft-navigation",n.navigationId)),!n.hadRecentInput){var i=a[0],l=a[a.length-1];r&&n.startTime-l.startTime<1e3&&n.startTime-i.startTime<5e3?(r+=n.value,a.push(n)):(r=n.value,a=[n])}}),r>t.value&&(t.value=r,t.entries=a,e())},d=x("layout-shift",u,i);d&&(e=p(n,t,O,i.reportAllChanges),L(function(){u(d.takeRecords()),e(!0),l=!0}),v(function(){c("back-forward-cache",t.navigationId),T(function(){return e()})}),o&&x("soft-navigation",function(r){r.forEach(function(r){var a=r.navigationId,o=a?w(a):null;a&&a!==t.navigationId&&o&&(o.startTime||0)>s&&(l||e(!0),c("soft-navigation",r.navigationId),e=p(n,t,O,i.reportAllChanges))})},i),setTimeout(e,0))},a=!1,function(e){a||(r(e),a=!0)}))},D=function(e,t){H(function(t){!function(e){if(e.entries.length){var t,n=e.entries[e.entries.length-1],i=0;if(e.navigationId&&e.navigationId!==u)i=(t=w(e.navigationId))?t.startTime:0;else if(t=c()){var r=t.activationStart||0;i=Math.max(0,t.responseStart-r)}if(t)return void(e.attribution={timeToFirstByte:i,firstByteToFCP:e.value-i,loadState:d(e.entries[0].startTime),navigationEntry:t,fcpEntry:n})}e.attribution={timeToFirstByte:0,firstByteToFCP:e.value,loadState:d(g())}}(t),e(t)},t)},R={passive:!0,capture:!0},F=new Date,$=function(e,t){r||(r=t,a=e,o=new Date,q(removeEventListener),_())},_=function(){if(a>=0&&a<o-F){var e={entryType:"first-input",name:r.type,target:r.target,cancelable:r.cancelable,startTime:r.timeStamp,processingStart:r.timeStamp+a};l.forEach(function(t){t([e])}),l=[]}},j=function(e){if(e.cancelable){var t,n,i,r=(e.timeStamp>1e12?new Date:performance.now())-e.timeStamp;"pointerdown"==e.type?(t=function(){$(r,e),i()},n=function(){i()},i=function(){removeEventListener("pointerup",t,R),removeEventListener("pointercancel",n,R)},addEventListener("pointerup",t,R),addEventListener("pointercancel",n,R)):$(r,e)}},q=function(e){["mousedown","keydown","touchstart","pointerdown"].forEach(function(t){return e(t,j,R)})},B=[100,300],U=function(e,t){var n=E(t=t||{});M(function(){var i,o=N(),s=y("FID"),c=function(r){r.forEach(function(r){var a,l;n?r.navigationId&&r.navigationId!==s.navigationId&&(a="soft-navigation",l=r.navigationId,o=N(!0),i=p(e,s=y("FID",0,a,l),B,t.reportAllChanges)):d.disconnect(),r.startTime<o.firstHiddenTime&&(s.value=r.processingStart-r.startTime,s.entries.push(r),s.navigationId=r.navigationId||u,i(!0))})},d=x("first-input",c,t);i=p(e,s,B,t.reportAllChanges),d&&L(function(){c(d.takeRecords()),n||d.disconnect()}),d&&v(function(){i=p(e,s=y("FID",0,"back-forward-cache",s.navigationId),B,t.reportAllChanges),l=[],a=-1,r=null,q(addEventListener),l.push(c),_()})})},V=function(e,t){U(function(t){var n;n=t.entries[0],t.attribution={eventTarget:f(n.target),eventType:n.name,eventTime:n.startTime,eventEntry:n,loadState:d(n.startTime)},e(t)},t)},z=0,K=null,X=0,J=null,Y=null,G=function(e){e.forEach(function(e){e.interactionId&&(Y&&e.navigationId&&e.navigationId!==J&&(J=e.navigationId,z=0,K=1/0,X=0),K=Math.min(K,e.interactionId),z=(X=Math.max(X,e.interactionId))?(X-K)/7+1:0)})},Q={},Z=[2500,4e3],ee=function(e,t){var n,i,r,a,o;n=function(t){(function(e){if(e.entries.length){var t,n=0,i=0,r=0;if(e.navigationId&&e.navigationId!==u?n=r=(t=w(e.navigationId))?t.startTime:0:(n=(t=c())&&t.activationStart?t.activationStart:0,i=t&&t.responseStart?t.responseStart:0),t){var a=e.entries[e.entries.length-1],o=a.url&&performance.getEntriesByType("resource").filter(function(e){return e.name===a.url})[0],l=Math.max(0,i-n),s=Math.max(l,o?(o.requestStart||o.startTime)-n:0),d=Math.max(s-r,o?o.responseEnd-n:0,0),h=Math.max(d-r,a?a.startTime-n:0,0),p={element:f(a.element),timeToFirstByte:l,resourceLoadDelay:s-l,resourceLoadTime:d-s,elementRenderDelay:h-d,navigationEntry:t,lcpEntry:a};return a.url&&(p.url=a.url),o&&(p.lcpResourceEntry=o),void(e.attribution=p)}}e.attribution={timeToFirstByte:0,resourceLoadDelay:0,resourceLoadTime:0,elementRenderDelay:e.value}})(t),e(t)},r=!1,a=E(i=(i=t)||{}),o=0,M(function(){var e,t=N(),l=y("LCP"),s=function(a,s){if(e=p(n,l=y("LCP",0,a,s),Z,i.reportAllChanges),r=!1,"soft-navigation"===a){t=N(!0);var c=w(s);o=c&&c.startTime?c.startTime:0}},c=function(n){n.forEach(function(n){if(n){a&&n.navigationId&&n.navigationId!==l.navigationId&&(r||e(!0),s("soft-navigation",n.navigationId));var i=0;if(n.navigationId&&n.navigationId!==u){var o=w(n.navigationId),c=o&&o.startTime?o.startTime:0;i=Math.max(n.startTime-c,0)}else i=Math.max(n.startTime-b(),0);n.startTime<t.firstHiddenTime&&(l.value=i,l.entries=[n],l.navigationId=n.navigationId||u,e())}})},d=function(){r||(c(h.takeRecords()),a||h.disconnect(),r=!0,e(!0))},h=x("largest-contentful-paint",c,i);h&&(e=p(n,l,Z,i.reportAllChanges),["keydown","click"].forEach(function(e){addEventListener(e,function(){return setTimeout(d,0)},!0)}),L(d),v(function(t){s("back-forward-cache",l.navigationId),T(function(){l.value=performance.now()-t.timeStamp,r=!0,e(!0)})}),a&&x("soft-navigation",function(t){t.forEach(function(t){var n=t.navigationId?w(t.navigationId):null;t.navigationId&&t.navigationId!==l.navigationId&&n&&(n.startTime||0)>o&&(r||e(!0),s("soft-navigation",t.navigationId))})},i))})},et=[800,1800],en=c(),ei=function e(t){document.prerendering?M(function(){return e(t)}):"complete"!==document.readyState?addEventListener("load",function(){return e(t)},!0):setTimeout(t,0)},er=function(e,t){var n=E(t=t||{}),i=y("TTFB"),r=p(e,i,et,t.reportAllChanges);ei(function(){if(en){var a=en.responseStart;!(a<=0||a>performance.now())&&(i.value=Math.max(a-b(),0),i.entries=[en],r(!0),v(function(){(r=p(e,i=y("TTFB",0,"back-forward-cache",i.navigationId),et,t.reportAllChanges))(!0)}),n&&x("soft-navigation",function(n){n.forEach(function(n){n.navigationId&&((i=y("TTFB",0,"soft-navigation",n.navigationId)).entries=[n],(r=p(e,i,et,t.reportAllChanges))(!0))})},t))}})},ea=function(e,t){er(function(t){!function(e){if(e.entries.length){var t=e.entries[0],n=t.activationStart||0,i=Math.max(t.domainLookupStart-n||0,0),r=Math.max(t.connectStart-n||0,0),a=Math.max(t.requestStart-n||0,0);e.attribution={waitingTime:i,dnsTime:r-i,connectionTime:a-r,requestTime:e.value-a,navigationEntry:t}}else e.attribution={waitingTime:0,dnsTime:0,connectionTime:0,requestTime:0}}(t),e(t)},t)}}}]);
//# sourceMappingURL=vendors-node_modules_github_quote-selection_dist_index_js-node_modules_github_session-resume_-b02a44-8bbc6a0dbd90.js.map